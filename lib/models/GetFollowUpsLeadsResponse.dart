class GetFollowUpsLeadsResponse {
  bool? success;
  List<Data>? data;
  Pagination? pagination;
  String? message;

  GetFollowUpsLeadsResponse(
      {this.success, this.data, this.pagination, this.message});

  GetFollowUpsLeadsResponse.fromJson(Map<String, dynamic> json) {
